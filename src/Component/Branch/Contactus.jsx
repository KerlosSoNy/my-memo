...
export default function ContactUs(){
    return(
        ...
        <div id="map" class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat">
            <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d362.7457736351903!2d31.366560582193657!3d30.121702085856572!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2seg!4v1705957935563!5m2!1sen!2seg"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="flex items-start">
                        ...
                        <p class="text-sm text-neutral-500">
                    5    شارع أحمد عبد النبى, النزهة الجديدة, القاهرة, مصر.
                        </p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="align-start flex">
                        ...
                        <div class="inline-block rounded-md bg-sky-200 p-4 text-primary">
                            ...
                            xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" class="w-7 h-7"
                            viewBox="0 0 111.756 122.879" enable-background="new 0 0 111.756 122.879" space="preserve">
                            <g>
                                <path
                        ...
                        <p class="text-neutral-500"> 0020-226205757
                        </p>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="align-start flex">
                        ...
                        <p class="text-neutral-500"> 0020-1000042768
                        </p>
                        </div>
                    </div>
                    </div>
