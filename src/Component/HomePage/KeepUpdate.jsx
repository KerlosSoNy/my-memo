...
export default function KeepUpdate(){
    return(
        <div class="mx-auto max-w-7xl mb-32 px-6 lg:px-8 mt-10">
            <div
                ...
                <svg viewBox="0 0 1024 1024" class="absolute left-1/2 top-1/2 -z-10 h-[64rem] w-[64rem] -translate-x-1/2"
                    ...
                    <defs>
                        <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641" cx="0" cy="0" r="1"
                            ...
                            <stop offset="1" stop-color="#8257f8" stop-opacity="0"></stop>
                        </radialGradient>
                    </defs>
                </svg>
